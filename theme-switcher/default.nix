...
let
  ...
  toggleTheme = pkgs.writeShellApplication {
    name = "toggle-theme";
    runtimeInputs = with pkgs; [ coreutils procps libnotify dconf dunst hyprland hyprpaper kitty ];
...
in
{
  ...
  xdg.configFile."theme-switcher/themes/dark/wlogout.css".text = builtins.replaceStrings [ "@WLOGOUT_ICONS@" ] [ "${pkgs.wlogout}/share/wlogout/icons" ] (builtins.readFile ./themes/dark/wlogout.css);
  ...
  xdg.configFile."theme-switcher/themes/light/wlogout.css".text = builtins.replaceStrings [ "@WLOGOUT_ICONS@" ] [ "${pkgs.wlogout}/share/wlogout/icons" ] (builtins.readFile ./themes/light/wlogout.css);
